...
该命令会后启动 Vite 开发服务器。开发服务器支持热模块替换（HMR），您对代码的修改会实时反映到扩展中。
...
**翻译加载提示**：设置在翻译过程中是否显示加载提示。启用后，当扩展处理翻译请求时，会在翻译文本旁边显示 "..." 动画提示。
...
- 项目 Issues：https://github.com/BreathHorizon/ling-translate/issues
- 邮箱：support@ling.rest
